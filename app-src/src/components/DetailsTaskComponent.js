...
import { TaskInfoTable } from './detailsTask/TaskInfoTable'
import { TaskMetricsContent } from './detailsTask/TaskMetricsContent'
    ...
    <div>
      <Card className={currentVariantClasses}>
        <Card.Header className="d-flex justify-content-between align-items-center">
          ...
          <ServiceStatusBadge state={currentTask.Status?.State} />
        </Card.Header>
        <Card.Body>
